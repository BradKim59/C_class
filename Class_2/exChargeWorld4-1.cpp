...
void outputCurrency(int selectCon, int outputFinal) {
	...
	int returnD100 = outputFinal/100;
	int returnD50 = outputFinal%100/50;
	int returnD20 = outputFinal%100%50/20;
	int returnD10 = outputFinal%100%50%20/10;
	int returnD5 = outputFinal%100%50%20%10/5;
	int returnD2 = outputFinal%100%50%20%10%5/2;
	int returnD1 = outputFinal%100%50%20%10%5%2;
	printf("100%s %d개, 50%s %d개, 20%s %d개, 10%s %d개, 5%s %d개, 2%s %d개, 2%s %d개  \n"
	...
	int returnD10 = outputFinal%1000%500%100%50/10;
	int returnD1 = outputFinal%1000%500%100%50%10;
	printf("1000%s %d개, 500%s %d개, 100%s %d개, 50%s %d개, 10%s %d개, 1%s %d개 \n"
	, curren, returnD1000, curren, returnD500, curren, returnD100, curren, returnD50, curren, returnD10, curren, returnD1);
	} else if (selectCon == 4) {
	int returnD100 = outputFinal/100;
	int returnD50 = outputFinal%100/50;
	int returnD20 = outputFinal%100%50/20;
	int returnD10 = outputFinal%100%50%20/10;
	int returnD5 = outputFinal%100%50%20%10/5;
	int returnD1 = outputFinal%100%50%20%10%5;
	printf("100%s %d개, 50%s %d개, 20%s %d개, 10%s %d개, 5%s %d개, 1%s %d개 \n"
	, curren, returnD100, curren, returnD50, curren, returnD20, curren, returnD10, curren, returnD5, curren, returnD1);
	} else if (selectCon == 5) {
	int returnD50 = outputFinal%100/50;
	int returnD20 = outputFinal%100%50/20;
	int returnD10 = outputFinal%100%50%20/10;
	...
	, curren, returnD50, curren, returnD20, curren, returnD10, curren, returnD5, curren, returnD1);
	}
}
...
int main() {
	...
	currency (selectCon);
	outputCurrency(selectCon, outputFinal);
